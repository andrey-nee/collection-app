<div class="main-header__container container">
  ...
  <div class="logo col d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
    ...
    <ul class="site-nav nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
      <li><a href="{{ route('welcome.index') }}" class="site-nav__link nav-link px-2 @linkactive('/')"
          data-page="welcome">Главная</a></li>
      <li><a href="{{ route('films.index') }}" class="site-nav__link nav-link px-2 @linkactive('films')"
          data-page="films">Фильмы</a></li>
    </ul>
